...
// HTTP behaviour is covered in coingecko_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "coingecko://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("coingecko", "about")
	if err != nil || got.String() != "coingecko://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want coingecko://page/about", got.String(), err)
	}
}
