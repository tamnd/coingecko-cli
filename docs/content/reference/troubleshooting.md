...
Most of these come down to network reality or how coingecko serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

coingecko rate-limits like any public site. coingecko already paces
...
Where a surface is gated, coingecko reads a cookie or token you supply
...
`coingecko`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what coingecko actually did
