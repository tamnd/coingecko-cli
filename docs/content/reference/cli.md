...
```
coingecko <command> [arguments] [flags]
```

Run `coingecko <command> --help` for the full flag list on any command. This
...
per operation you declare in `coingecko/domain.go`.
